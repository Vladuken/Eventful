...
import com.vladuken.features.events.presentation.events.favorite.FavoriteEventListViewModel
...
internal val viewModelModule = module {
    viewModel<BaseRecentEventListViewModel>(named(BaseRecentEventListViewModel.Strategy.RECENT)) {
    ...
    viewModel<BaseRecentEventListViewModel>(named(BaseRecentEventListViewModel.Strategy.FAVORITE)) {
        FavoriteEventListViewModel(
            fetchFavoriteEventsUseCase = get(),
            toggleEventUseCase = get()
        )
    }
